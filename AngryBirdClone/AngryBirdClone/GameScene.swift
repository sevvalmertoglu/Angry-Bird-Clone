...
//  AngryBirdClone
//
//  Created by Şevval Mertoğlu on 12.05.2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        /*
         ...
         bird2.zPosition = 1
         self.addChild(bird2)
         (I created view with code)
  */
        
        //Physics body
        self.physicsBody = SKPhysicsBody(edgeLoopFrom: frame) //no object can leave the screen boundaries
        self.scene?.scaleMode = .aspectFit
        self.physicsWorld.contactDelegate = self //we will have an option to detect contacts
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        //this function is called if the objects we create touch each other
